...
public class QuizQuestion2 extends AppCompatActivity {
    ...
    private final int CORRECT_ANSWER = 4; // The India option is correct (4th option)

    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.quiz_qustion_2);
    ...
    private void checkAnswer() {
        ...
        if (selectedOption == CORRECT_ANSWER) {
            ...
            cardOption4.setCardBackgroundColor(Color.parseColor("#8BC34A")); // Light green for correct
            Toast.makeText(this, "Correct!", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(QuizQuestion2.this, QuizQuestion3.class));
        } else {
            ...
            cardOption4.setCardBackgroundColor(Color.parseColor("#8BC34A"));
